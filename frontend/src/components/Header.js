                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        ...
                        {props.userProps.isAdmin ? <NavDropdown title="Admin" id="basic-nav-dropdown">
                            ...
                            <NavDropdown.Item href="#action/3.2">Employees</NavDropdown.Item>
                            <NavDropdown.Item href="#action/3.2">Pets</NavDropdown.Item>
                            <NavDropdown.Item href="#action/3.2">Appointments</NavDropdown.Item>
                        </NavDropdown> : ''}
                    </Nav>
                </Navbar.Collapse>
